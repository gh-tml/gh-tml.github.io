...
* [Dragon Ball Terraria](https://github.com/AlphEEE/DBZMOD) -- Adds a custom energy system with some UI elements, a custom damage type, quite a few unique weapons and transformational effects.
...
* [Example Mod](https://github.com/tModLoader/tModLoader/tree/stable/ExampleMod) -- Offers a wide variety of code examples covering Beginner to Expert.
...
* [Qwerty's Bosses and Items](https://github.com/qwerty3-14/QwertyMod) -- Adds a lot of interesting things. Has a lot uses of custom npc AIs (including bosses), an invasion, custom minion/sentry AIs, player layers and more.
...
* [Terraria Overhaul](https://github.com/Mirsario/TerrariaOverhaul) -- Hundreds of mechanics implemented in readable and scalable code. Also serves as a good reference on advanced concepts such as injections, data-driven content, video playback, lighting buffers, scalable GUI, "event recording", etc.
...
* [Quality of Terraria](https://github.com/487666123/ImproveGame) -- All the basic and advanced modding: UI, shader, save and load data, multiplayer, On, IL, localization and a lot more. 
...
* [Wireless](https://github.com/goldenapple3/Wireless) -- Wiring related code, storing custom tile information using ModSystem.
* [Auto Fisher](https://github.com/Silencersn/AutoFisher) -- Modify the vanilla fishing mechanism by mainly using IL, On and Reflection. And provide players with various options to customize their own fishing experience through configs.
